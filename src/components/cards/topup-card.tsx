...
const TopupCard: FC<ITopupCardProps> = ({ className, id, name, image, price, detail, gameId, isActive, closeDate, resetDate }) => {
    // _Memo
        ...
        >
            ...
            >
                ...
                <div className={cn(`px-8 pb-8 pt-4`)}>
                    ...
                    {closeDate ? <Countdown className='text-white mx-auto mt-1' date={closeDate} /> : <></>}
                    {resetDate ? <Countdown className='text-white mx-auto mt-1' date={resetDate} /> : <></>}
                    {/* </div> */}
                </div>
            </div>
        </div>
